...
- [MoonProxy](https://github.com/MoonProxyHQ/moonproxy-desktop) - Cross-platform GUI desktop client for FRP (frpc), making intranet penetration accessible to non-technical users. ([Demo](https://moonproxy.app)) `MIT` `Rust/Docker`
